...
class TextDetector extends StatefulWidget {
  TextDetector({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  TextDetectorState createState() => TextDetectorState();
}

class TextDetectorState extends State<TextDetector> {
  String _ocrText = '';
  String _ocrHocr = '';
  ...
  Future<void> getBytesFromCamerImage(CameraImage image) async {}
